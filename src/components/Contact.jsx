...
function Contact() {
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="This is the contact page for DreamCatcherzz design team"
      />
      <meta
        name="keywords"
        content="DreamCatcherzz,Dreamcatchers,Shilpa Rawat,Kashyap Rawat,Designers,Interior Designers, Contact dreamcatchers"
      />
