    ...
    <div className="h-fitcontent w-full flex-row my-5 " id="container">
      <div className=" flex-wrap w-full inline-flex align-center justify-evenly p-5 ">
        ...
        <div className=" inline-flex align-top my-10  h-fit lg:w-1/2 md:w-3/4">
          ...
          iusto laboriosam eligendi modi aliquam. Lorem ipsum dolor sit amet,
          consectetur adipisicing elit. Laudantium autem consequatur nesciunt
          voluptates, reiciendis dolorum dicta ex, sequi esse fuga ad iusto,
          explicabo commodi neque?
        </div>
